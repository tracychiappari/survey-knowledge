...
SurveyKnowledge.Utilities.ucwords = function(self, str)
...
SurveyKnowledge.Utilities.format = function(self, str)
...
SurveyKnowledge.Utilities.parseSurveyName = function(self, surveyName)
...
SurveyKnowledge.Utilities.getInventory = function(Utilities, type)
  local inventory = {}
